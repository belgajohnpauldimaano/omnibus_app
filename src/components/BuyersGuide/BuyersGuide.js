    ...
    <Root>
        <Container>
          {/* <StatusBar
            hidden={true}
          /> */}
            <HeaderContainer {...this.props} title={'Buyers Guide'} subtitle={''} />
            <Content padder>
                ...
                <Card>
                      <View style={{ width:'100%', marginTop : 0, height : '100%' }}>
                        <ImageViewer images={[
                          { source : require('./../../assets/images/guide/guide-1.jpg'), width : 800, height : 600 }
                        ]} />
                      </View>
                </Card>
                <Card>
                      <View style={{ width:'100%', marginTop : 0, height : '100%' }}>
                        <ImageViewer images={[
                          { source : require('./../../assets/images/guide/guide-2.jpg'), width : 800, height : 600 }
                        ]} />
                      </View>
                </Card>
                <Card>
                      <View style={{ width:'100%', marginTop : 0, height : '100%' }}>
                        <ImageViewer images={[
                          { source : require('./../../assets/images/guide/guide-3.jpg'), width : 800, height : 600 }
                        ]} />
                      </View>
                </Card>
                <Card>
                      <View style={{ width:'100%', marginTop : 0, height : '100%' }}>
                        <ImageViewer images={[
                          { source : require('./../../assets/images/guide/guide-4.jpg'), width : 800, height : 600 }
                        ]} />
                      </View>
                </Card>
                <Card>
                      <View style={{ width:'100%', marginTop : 0, height : '100%' }}>
                        <ImageViewer images={[
                          { source : require('./../../assets/images/guide/guide-5.jpg'), width : 800, height : 600 }
                        ]} />
                      </View>
                </Card>
                <Card>
                      <View style={{ width:'100%', marginTop : 0, height : '100%' }}>
                        <ImageViewer images={[
                          { source : require('./../../assets/images/guide/guide-6.jpg'), width : 800, height : 600 }
                        ]} />
                      </View>
                </Card>
                <Card>
                      <View style={{ width:'100%', marginTop : 0, height : '100%' }}>
                        <ImageViewer images={[
                          { source : require('./../../assets/images/guide/guide-7.jpg'), width : 800, height : 600 }
                        ]} />
                      </View>
                </Card>
            </Content>
